...
#   *nuevos limites para los parametros de la bayesiana visto corridas anteriores y menos iteraciones para ahorrar tiempo
...
PARAM  <- list()
PARAM$experimento  <- "WAL_HT_03"

PARAM$exp_input  <- "WAL_TS_03"
...
PARAM$bo_lgb <- makeParamSet(
         ...
         makeIntegerParam("num_leaves",       lower=    128L,   upper=  1024L),
         makeIntegerParam("min_data_in_leaf", lower=  9000L,   upper= 35000L)
        )
